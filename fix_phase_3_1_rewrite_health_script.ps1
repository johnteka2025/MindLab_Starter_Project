# fix_phase_3_1_rewrite_health_script.ps1
# Rewrites phase_3_1_add_health_endpoint.ps1 from scratch (canonical version) and parse-checks it.
...
$target = "C:\Projects\MindLab_Starter_Project\phase_3_1_add_health_endpoint.ps1"

$code = @'
# phase_3_1_add_health_endpoint.ps1
# Phase 3.1 — Backend/API robustness: add GET /health + contract test (self-contained)
...
Ok "PHASE 3.1 COMPLETE — /health + self-contained test added."
'@
...
if($errors -and $errors.Count -gt 0){
  ...
  Fail "Target parse failed"
}
Ok "Target parse check GREEN."
Info "Next: run phase_3_1_add_health_endpoint.ps1"
