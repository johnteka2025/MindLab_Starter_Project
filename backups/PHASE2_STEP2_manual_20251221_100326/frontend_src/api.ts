...
export async function solvePuzzle(puzzleId: string): Promise<any> {
  // Calls backend progress solve endpoint; backend is source of truth
  return api<any>("/progress/solve", {
    method: "POST",
