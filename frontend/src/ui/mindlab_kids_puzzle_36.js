function renderKidsPuzzle36(containerId) {
    const host = document.getElementById(containerId);
    if (!host) throw new Error("Puzzle 36 host not found");
    ...
    host.innerHTML = `
        <div class="mindlab-kids-puzzle">
            ...
            <div id="mindlab-kids-puzzle-36-feedback"></div>
        </div>
    `;

    const feedback = host.querySelector("#mindlab-kids-puzzle-36-feedback");
...
if (typeof module !== "undefined") {
    module.exports = { renderKidsPuzzle36 };
}
